...
def train_faces():
    ...
    # First check if encodings.pickle already exists
    print("[INFO] Checking if training is required...")

    # If the file exists, skip training and exit
    if os.path.exists(FACE_DATA_FILE):
        print("[INFO] Encodings already exist. Skipping training.")
        return
